...
knit2synapse::createAndKnitToFolderEntity(file = "./cmc-rnaseq-de/HBCC_ACC-Nirmala_FEATURECOUNTS_GRCh38_CQN_Sparse.Rmd",
                                          ...
                                          folderName = 'HBCC - ACC-Nirmala - FEATURECOUNTS - GRCh38 - CQN - Sparse Model')
```
...
correlation <- CovariateAnalysis::parallelDuplicateCorrelation(VOOM.GENE_EXPRESSION, block = COVARIATES$Individual_ID)
...
# Code
CODE <- Folder(name = "HBCC - ACC-Nirmala - FEATURECOUNTS - GRCh38 - CQN - Sparse Model", parentId = parentId)
CODE <- synStore(CODE)
