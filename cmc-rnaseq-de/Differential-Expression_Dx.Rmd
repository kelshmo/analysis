---
title: "Differential Expression - Dx"
...
knit2synapse::createAndKnitToFolderEntity(file = "./cmc-rnaseq-de/Differential-Expression_Dx.Rmd",
                                 parentId ="syn21859863",
...
thisFileName <- 'Differential-Expression_Dx.Rmd'
...
adjust.covars <- c("Dx", "RIN", "rRNARate", "IntergenicRate")
```
...
COVARIATES.tmp = data.matrix(COVARIATES[,c('Dx'), drop = F])
...
mart <- biomaRt::useMart(biomart = "ENSEMBL_MART_ENSEMBL",
                host = "useast.ensembl.org", # Ensembl Release 99 (January 2020)
...
RESIDUAL.GENE_EXPRESSION %>%
  ...
  write.table(file = 'CMC_HBCC_DLPFC_Dx_netResidualExpression.tsv', sep = '\t', row.names=F, quote=F)
nEXP_OBJ = File('CMC_HBCC_DLPFC_Dx_netResidualExpression.tsv', 
...
write.table(DE, file = 'CMC_HBCC_DLPFC_Dx_DiffExpression.tsv', sep = '\t', row.names=F, quote=F)
DEXP_OBJ = File('CMC_HBCC_DLPFC_Dx_DiffExpression.tsv', 
...
saveRDS(ADJUSTED.FIT, file = 'CMC_HBCC_DLPFC_Dx_dream-output.rds')
ADJ_OBJ = File('CMC_HBCC_DLPFC_Dx_dream-output.rds',
