...
fitMixedEffectModel <- function(varsToFit, random_effect, lcpm, covars, covars_to_fit){
...
# Stepwise regression
phase1 <- mvBIC::mvForwardStepwise(exprObj = subset_CQN,
                         baseFormula = base_formula, 
                         data = COVARIATES,
                         variables = array(c("Institution", "Reported_Gender", "PMI", 
                                                             "ageOfDeath", "RIN", "RIN2", "EV.1", 
                                                             "EV.2", "EV.3", "EV.4", "EV.5")))
phase1
```
...
```{r phase2}
phase2 <- mvBIC::mvForwardStepwise(exprObj = subset_CQN,
                         baseFormula = phase1$formula, 
                         data = COVARIATES,
                         variables = array(c("LibraryBatch", "FlowcellBatch")))
phase2
```
...
phase3 <- mvBIC::mvForwardStepwise(exprObj = subset_CQN,
                         ...
                         data = COVARIATES,
                         variables = array(c("MappedReads", "IntragenicRate", "IntronicRate", "IntergenicRate", "GenesDetected", "rRNARate", "TotalReads")))
phase3
```
