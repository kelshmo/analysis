...
L7 = variancePartition::getContrast(exprObj = VOOM.GENE_EXPRESSION, 
                                   formula = formula, 
                                   data = COVARIATES, 
                                   coefficient = c("Dx.TissueSCZ_DLPFC", "Dx.TissueSCZ_ACC"))
L8 = variancePartition::getContrast(exprObj = VOOM.GENE_EXPRESSION, 
                                   formula = formula, 
                                   data = COVARIATES, 
                                   coefficient = c("Dx.TissueControl_DLPFC", "Dx.TissueControl_ACC"))
L9 = variancePartition::getContrast(exprObj = VOOM.GENE_EXPRESSION, 
                                   formula = formula, 
                                   data = COVARIATES, 
                                   coefficient = c("Dx.TissueOther_DLPFC", "Dx.TissueOther_ACC"))
...
contrast <- c(glue::glue_collapse(names(L1[L1 != 0]), "-"), 
              ...
              glue::glue_collapse(names(L7[L7 != 0]), "-"),
              glue::glue_collapse(names(L8[L8 != 0]), "-"),
              glue::glue_collapse(names(L9[L9 != 0]), "-")
)
...
DE = lapply(glue::glue("L{1:9}"), function(i, FIT){
