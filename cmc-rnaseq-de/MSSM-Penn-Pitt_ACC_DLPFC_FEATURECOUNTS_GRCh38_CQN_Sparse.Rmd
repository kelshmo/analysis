...
phase1 <- mvBIC::mvForwardStepwise(exprObj = subset_CQN,
                         ...
                         data = COVARIATES,
                         variables = array(c("(1|Institution)", "(1|Reported_Gender)", "PMI", 
...
phase3 <- mvBIC::mvForwardStepwise(exprObj = subset_CQN,
                         ...
                         data = COVARIATES,
                         variables = array(c("IntragenicRate", "IntronicRate","IntergenicRate","rRNARate", "(1|TotalReads)", "GenesDetected", "MappedReads")))
phase3
```
