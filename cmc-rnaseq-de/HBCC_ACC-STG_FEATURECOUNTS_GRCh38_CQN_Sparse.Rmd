---
title: "HBCC - ACC - STG - DREAM - FEATURECOUNTS - GRCh38 - CQN"
author: "Kelsey Montgomery, Gabriel Hoffman and Thanneer Perumal"
date: "`r date()`"
...
knit2synapse::createAndKnitToFolderEntity(file = "./cmc-rnaseq-de/HBCC_ACC-STG_FEATURECOUNTS_GRCh38_CQN_Sparse.Rmd",
                                          ...
                                          folderName = 'HBCC - ACC - STG - DREAM - FEATURECOUNTS - GRCh38 - CQN')
```
...
hist(CQN.GENE_EXPRESSION$E, main = 'Distribution of correlation between genes', xlab = 'Correlation')
```
...
# Code
CODE <- Folder(name = "HBCC - ACC - STG - DREAM - FEATURECOUNTS - GRCh38 - CQN", parentId = parentId)
CODE <- synStore(CODE)
