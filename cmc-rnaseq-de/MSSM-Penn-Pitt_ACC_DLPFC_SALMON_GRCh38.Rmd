...
#ENST00000416330.2 and ENST00000329134.9 
FILT <- REPORTED.GENDER.COUNTS %>% 
  filter(transcript_id == "ENST00000416330.2" | transcript_id == "ENST00000329134.9") %>% 
  dplyr::select(-one_of("chromosome_name")) %>% 
  tidyr::spread(key = transcript_id, value = `counts(log)`) %>% 
  mutate(XIST = as.numeric(`ENST00000416330.2`)) %>% 
  mutate(UTY = as.numeric(`ENST00000329134.9`))
...
```{r cpmnormalisation, cache.lazy = FALSE}
